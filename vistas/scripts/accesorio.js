...
.---------------------------------------------*/
function mostrarclick(nombreaccesorio, descripcion, imagen, rutaservidor) {
       ...
       $.confirm({
         ...
         content: ''+`<div class='report-module'>
                   <div class="text-center">
                     <img src="`+rutaservidor+imagen+`" class="imagepreview">
                   </div>
   ...
   $.post("../ajax/accesorio.php?op=mostrar", {
      ...
      if (data.imagen == "") {
         $("#imagenmuestra").attr("src", "../public/img/product-default.jpg");
          ...
          $("#imagenmuestra").attr("src", "http://localhost/backend_mod/" + data.imagen).width('auto');
