                                       ...
                                       <div class="col-md-4 col-xs-12">
                                          ...
                                          --------------------------------------------------> 
                                             <div class="form-group">
                                                ...
                                                <input type="text" indice="`+index+`" value="" class="slider form-control posVertical" data-slider-min="0" data-slider-max="50" data-slider-step="1" data-slider-value="`+estiloImgProducto.top+`" data-slider-orientation="horizontal" data-slider-selection="before" data-slider-tooltip="show" data-slider-id="red">
                                                ...
                                                <input type="text" indice="`+index+`" value="" class="slider form-control anchoImagen" data-slider-min="0" data-slider-max="50" data-slider-step="1" data-slider-value="`+estiloImgProducto.width+`" data-slider-orientation="horizontal" data-slider-selection="before" data-slider-tooltip="show" data-slider-id="green">
...
function PosicionamientosSlide(){ 
   var guardarSlide = $(".guardarSlide"); 
   var slideOpciones = $(".slideOpciones"); 
