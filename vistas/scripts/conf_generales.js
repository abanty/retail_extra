...
function mostrar(){
   ...
   $.post("../ajax/configuracion.php?op=mostrar_informacion_entidad",function(data){
      ...
      if (data_decode.datos_empresa == null && data_decode.datos_plantilla == null) {
         ...
         if (data_decode.datos_plantilla["logo"] == "") {
            ...
            $("#imagenmuestra_logo").attr("src", "http://localhost/backend_retail/" + data_decode.datos_plantilla["logo"]).width('auto');   
         ...
         if (data_decode.datos_plantilla["extra_logo"] == "") {
            ...
            $("#imagenmuestra_extra").attr("src", "http://localhost/backend_retail/" + data_decode.datos_plantilla["extra_logo"]).width('250px');   
         ...
         if (data_decode.datos_plantilla["icono"] == "") {
            ...
            $("#imagenmuestra_favicon").attr("src", "http://localhost/backend_retail/" + data_decode.datos_plantilla["icono"]).width('50px');   
