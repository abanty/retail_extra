...
<!--Contenido-->
    ...
    <!-- - - - - - - - - - - - -
     ...
     - - - - - - - - - - - - --->
     <div class="modal fade" id="modal-accesorio" tabindex="-1" role="dialog">
       ...
       <div class="modal-content">
          <div class="modal-header" style="background: #3c8dbc; color:white;">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
             ...
             <button id="clickdisapear" style="float: right;margin-top: -5px;color: white;" type="button" class="btn btn-box-tool" data-toggle="control-sidebar"><i class="fa fa-gears"></i>
                </button>
          ...
          <div class="modal-body">
              <form name="formulario" id="formulario" method="POST">
                   ...
                   <div class="form-group col-lg-4 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="form-group col-lg-3 col-md-5 col-sm-5 col-xs-12">
                           ...
                           <select class="form-control selectpicker show-tick"  title="Selecciona..." data-style="btn-primary" id="tipo_accesorio" name="tipo_accesorio" data-live-search="true">
                             <option data-icon="fa fa-check-square-o" value="transmidora">Transmisora</option>
                ...
                <!-- Control Sidebar -->
                <aside id="ctrl" class="control-sidebar control-sidebar-dark">
                     ...
                     <div class="tab-pane" id="control-sidebar-settings-tab">
                        <div class="form-group col-md-12">
                           <label for="color" class="col-sm-3 control-label">Color: </label>
                             ...
                             <input id="agregarcolor" type="button" class="btn btn-default" value="Mi Color Seleccionado" style="font-family: 'Courgette', cursive;">
                        ...
                        <div class="form-group col-md-12">
                             ...
                             <div class="box-body">
                                ...
                                <!-- <a id="space_marcacolor" class="text-black" href="#"><i id="marcacolor" class="fa fa-heart"></i></a> -->
