  ...
  case 'mostrar':
   ...
   break;
	...
	case 'listar':
		...
		while ($reg=$rspta->fetch_object()) {
			$ruta_servidor = "http://localhost/backend_retail/";
			...
			'<img style="cursor: pointer; width: 50px;" src="'.$ruta_servidor.$reg->imagen.'" onclick="mostrarclick(\''.$reg->nombre.'\',\''.limpiarCadena($reg->descripcion).'\',\''.$reg->imagen.'\',\''.$ruta_servidor.'\')" data-toggle="tooltip" data-html="true" title="<em>Ver</em> <u>detalles del</u> <b>Accesorio</b>">';
