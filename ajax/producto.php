...
switch ($_GET["op"]){
    ...
    case 'listar':
		...
		while ($reg=$rspta->fetch_object()) {
			$ruta_servidor = "http://localhost/backend_mod/";
			...
			'<img style="cursor: pointer; width: 50px;" src="'.$ruta_servidor.$reg->imagen.'" onclick="mostrarclick(\''.$reg->nombre.'\',\''.limpiarCadena($reg->descripcion).'\',\''.$reg->imagen.'\',\''.$ruta_servidor.'\')">';
