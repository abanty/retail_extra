...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-04-2020 a las 09:19:31
...
INSERT INTO `accesorio` (`idaccesorio`, `nombre`, `nuevo`, `ruta`, `tipo_accesorio`, `rango_option`, `rango`, `stock`, `cantidad_min_option`, `cantidad_min`, `descripcion`, `imagen`, `multimedia`, `entrega`, `ventas`, `vistas`, `color`, `style`, `fecha_create_update`, `estado`) VALUES
(6, 'antena recept XXX', 0, '', 'receptora', 1, 100, 0, 1, 50, 'antena recept XXX', '/files/accesorios/1587775316.jpg', '', 0, 0, 0, '', '', '2020-04-25 00:41:11', 1),
(9, 'sensor para zapatos', 0, '', '', 1, 100, 0, 1, 50, 'sensor para zapatos', '/files/accesorios/1587772220.jpg', '', 0, 0, 0, '', '', '2020-04-24 23:50:20', 1),
(10, 'sensor polo', 0, '', '', 1, 100, 0, 1, 100, 'sensor polo', '/files/accesorios/1587772247.jpg', '', 0, 0, 0, '', '', '2020-04-24 23:50:46', 1),
(11, 'Antenas Transmidora RTX', 0, '', 'transmisora', 1, 100, 0, 1, 10, 'Antenas Transmidora RTX', '/files/accesorios/1587772324.png', '', 0, 0, 0, '', '', '2020-04-24 23:52:04', 1),
(12, 'antenas receptora rtx', 0, '', 'receptora', 0, 0, 0, 1, 20, 'antenas receptora rtx', '/files/accesorios/1587773231.jpg', '', 0, 0, 0, '', '', '2020-04-25 00:07:11', 1);
...
(8, 9, 1, 0, '2020-04-24 23:50:20'),
(9, 10, 1, 0, '2020-04-24 23:50:46'),
(10, 11, 1, 1, '2020-04-24 23:52:04'),
(12, 6, 1, 1, '2020-04-25 00:41:56');
...
CREATE TABLE `producto` (
  ...
  `valoracion` text COLLATE utf8_spanish_ci NOT NULL,
  `nombre` varchar(70) COLLATE utf8_spanish_ci NOT NULL,
...
INSERT INTO `producto` (`idproducto`, `idcategoria`, `idsubcategoria`, `tipo`, `valoracion`, `nombre`, `descripcion`, `rango`, `rango_option`, `ruta`, `detalles`, `multimedia`, `nuevo`, `entrega`, `ventas`, `vistas`, `stock`, `imagen`, `estado`, `fecha`) VALUES
...
--
ALTER TABLE `accesorio`
  MODIFY `idaccesorio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT de la tabla `accesorio_producto`
--
ALTER TABLE `accesorio_producto`
  MODIFY `idaccesorio_producto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
